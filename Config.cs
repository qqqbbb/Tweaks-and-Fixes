...
namespace Tweaks_Fixes
{
    ...
    public class Config : ConfigFile
    {
        ...
        [Toggle("Drop tool in your hands when taking damage", Tooltip = "Chance to drop your tool is equal to amount of damage taken. If you take 30 damage, there is 30% chance you will drop your tool.")]
        public bool dropHeldTool = false;

        [Toggle("Stalkers grab tools from player's hands when playing", Tooltip = "Stalkers can grab only things that are in the config's 'stalkerPlayThings' list.")]
        public bool stalkersGrabShinyTool = false;

        [Slider("Chance percent of stalker losing its tooth", 0, 100, DefaultValue = 50, Step = 1, Format = "{0:F0}", Tooltip = "Probability percent of a stalker losing its tooth when biting something hard.")]
        public int stalkerLoseToothChance = 50;
        ...
        [Slider("Creature decoy HP", 0, 500, DefaultValue = 0, Step = 10, Format = "{0:F0}", Tooltip = "When this is not 0 creature decoy will be destroyed after taking this amount of damage. By default its HP is infinite.")]
        ...
        public bool configSettingsCopied = false;
        ...
        {
            { "PrecursorKey_Blue", 5f },
            { "PrecursorKey_Orange", 5f },
            { "PrecursorKey_Purple", 5f },
            { "PrecursorKey_Red", 5f },
            { "PrecursorKey_White", 5f },
        };
        ...
        public bool removeCookedFishFromBlueprints = true;
